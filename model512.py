...
class VGGBase(nn.Module):
    ...
    def forward(self, image):
        ...
        out = self.pool5(out)  # (N, 512, 32, 32), pool5 does not reduce dimensions
...
class AuxiliaryConvolutions(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv12_2 = nn.Conv2d(128, 256, kernel_size=2, padding=0)  # dim. reduction because padding = 0
...
class SSD512(nn.Module):
    ...
    def forward(self, image):
        ...
        conv8_2_feats, conv9_2_feats, conv10_2_feats, conv11_2_feats, conv12_2_feats = self.aux_convs(conv7_feats)
    ...
    def detect_objects(self, predicted_locs, predicted_scores, min_score, max_overlap, top_k):
        ...
        for i in range(batch_size):
            ...
            # (24564, 4), these are fractional pt. coordinates
...
class MultiBoxLoss(nn.Module):
    ...
    def forward(self, predicted_locs, predicted_scores, boxes, labels):
        ...
        # Note: indexing with a torch.uint8 (byte) tensor flattens the tensor when indexing is across multiple
        # dimensions (N & 8732)
        # So, if predicted_locs has the shape (N, 8732, 4), predicted_locs[positive_priors] will have (total
        # positives, 4)
        ...
        # As in the paper, averaged over positive priors only, although computed over both positive and hard-negative
        # priors
