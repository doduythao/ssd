I'm using `PyTorch 1.2`, `Python 3.6`, torchvision `0.4`, Pillow `7.2`

# Objective

We implement [Single Shot Multibox Detector (SSD)](https://arxiv.org/abs/1512.02325), a popular, powerful, and especially nimble network for this task.
...
See and use [this repo](https://github.com/Cartucho/mAP)
